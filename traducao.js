...
var translations = {
    pt: {
        homeOptions: {
            ...
            aplicativo: "Carbonograma versão 1.0",
        ...
        dicas: {
            titulo2: "Como fazer o bem",
            t0: "Dicas extras",
            titulo3: "Outras ações que podem ser feitas para reduzir a sua pegada de carbono",
            t19: "Mas então, como posso reduzir minha pegada de carbono? Plantar árvores é a única opção? A resposta é não! Existem dezenas de ações que você pode tomar para diminuir a quantidade de dióxido de carbono que emite. Aqui estão algumas delas:",

            t20: "Optar por consumir produtos locais e sazonais.",
            t21: "Reduzir o consumo de carne, especialmente carne bovina.",
            t22: "Escolher peixes de pesca sustentável.",
            t23: "Utilizar sacolas reutilizáveis e evitar comprar produtos com embalagens de plástico desnecessárias.",
            t24: "Comprar apenas o necessário para evitar o desperdício.",
            t25: "Preferir alimentos orgânicos.",
            t26: "Usar sacolas retornáveis.",
            t27: "Incorporar pelo menos uma refeição vegetariana por semana.",
            t28: "Praticar a compostagem de resíduos orgânicos.",
            t29: "Implementar sistemas de iluminação inteligente, se possível.",
            t30: "Optar por meios de transporte coletivo, escolhendo veículos que emitem menos CO2, ou considerar a bicicleta ou caminhada como opções de deslocamento.",
            t31: "Reduzir o uso de combustíveis fósseis.",
            n1: "Próximo",
            n2: "Anterior",
            n3: "Entendi",
            titulo4: "Motor de busca Ecosia",
            t41: "Constantemente, milhares de pessoas estão pesquisando informações na internet. E se cada pesquisa feita pudesse contribuir para o plantio de uma árvore? Já parou para imaginar o quanto isso poderia beneficiar o nosso planeta? Cristian Krool, após viajar pelo mundo e perceber o quão danoso poderia ser o desmatamento, teve a mesma ideia. Com o apoio de sua startup alemã, ele criou o Ecosia: um motor de busca que, a cada pesquisa realizada, doa uma árvore para a campanha 'Plant a Billion Trees' - que significa 'plante um bilhão de árvores'. Mas você pode estar se perguntando: como eles conseguem fazer isso? Na verdade, o principal objetivo do Ecosia é destinar pelo menos 80% dos lucros gerados com anúncios publicitários para campanhas de reflorestamento, como a 'Plant a Billion Trees' mencionada anteriormente.",
            t42: "Usar o Ecosia é simples. Se estiver no celular, acesse a Play Store, digite 'Ecosia' e, quando encontrá-lo, clique em 'Instalar'. Em poucos segundos, você poderá contribuir com essa iniciativa. Caso esteja usando o computador ou o notebook, acesse o navegador Bing (no Microsoft Edge) ou o Google Chrome, vá até a loja de extensões e pesquise por 'Ecosia'. Para começar a utilizá-lo, baixe a extensão e ative-a em seu navegador.",
            t43: "E por que você deveria usar o Ecosia? Aqui estão duas boas razões:",
            t44: "1) Se você ainda tem dúvidas sobre como os desenvolvedores do Ecosia usam o dinheiro que ganham, pode ficar tranquilo, pois o Ecosia é uma empresa que valoriza a transparência. Mensalmente, eles publicam um relatório financeiro do mês, demonstrando a receita arrecadada e o valor investido em campanhas de reflorestamento.",
            t45: "2) Uma das últimas preocupações do Ecosia é utilizar seus dados. Na verdade, o Ecosia protege suas informações e pesquisas por meio de uma conexão criptografada totalmente segura.",
    ...
    en: {
        ...
        homeOptions: {
            title: "Options",
            subtitle: "About",
            aplicativo: "Carbonograma version 1.0",
            copyright: "Copyright © Centro Educacional da Fundação Salvador Arena",
        ...
        dicas: {
            titulo2: "Doing Good",
            t0: "Extra Tips",
            titulo3: "Other actions that can be taken to reduce your carbon footprint!",
            t19: "So, what else can I do to reduce my carbon footprint? Planting trees is the only option? Of course not! There are dozens of actions that you can take in order to lower the quantity of carbon dioxide that you emit. Here are some of them:",
            t20: "Choose to consume local and seasonal products.",
            t21: "Reduce the consumption of meat, especially beef.",
            t22: "Go for sustainable fishing fish.",
            t23: "Utilize reusable bags and avoid buying products with unnecessary plastic packaging.",
            t24: "Buying only what you really need to avoid waste.",
            t25: "Give preference to organic foods.",
            t26: "Use returnable bags.",
            t27: "Incorporate at least one vegetarian meal per week.",
            t28: "Practice the composting of organic waste.",
            t29: "Implement smart illumination systems, if 	possible.",
            t30: "Going for public transportation means, choosing vehicles that emit less CO2, or consider the use of a bicycle or walk as dislocation options",
            t31: "Reduce the usage of fossil fuels.",
            n1: "Next",
            n2: "Previous",
            n3: "Alright",
            titulo4: "Ecosia Search Engine",
            t41: "Time and again, thousands of people are searching for information on the internet. So, what if each one of these searches could contribute to the planting of a tree? Have you ever imagined how much this could benefit our planet? Well, Cristian Krool, after going all over the world and noticing how harmful deforestation could be, has. With the support of his sister's German startup, he created Ecosia: a search engine that, for every search made, donates a tree to the 'Plant a Billion Trees' campaign. But now you may be wondering: how can they do that? In fact, the main goal of Ecosia is dedicating at least 80% of the generated profit to reforestation campaigns, such as 'Plant a Billion Trees,' as we just mentioned.",
            t42: "Using Ecosia is pretty simple. If you are using your mobile, access the Play Store, type in 'Ecosia', and when you find it, click on the 'installing' button. In a few seconds, you will be able to contribute to this initiative. In case you are using a computer or laptop, access Bing browser (on Microsoft Edge) or Google Chrome, go to the extensions store, and search for 'Ecosia'. In order to start using it, download the extension and activate it in your browser.",
            t43: "And why should you use Ecosia? Here are two good reasons:",
            t44: "1) If you still have doubts about how Ecosia developers use the money they receive from it, relax, Ecosia is a company that values openness. Monthly, they publish a financial report, showing their collected income and the value invested in reforestation campaigns.",
            t45: "2) Ecosia's least worrying is utilizing your private data. Actually, Ecosia always protects your info and searches through a totally safe encrypted connection.",
